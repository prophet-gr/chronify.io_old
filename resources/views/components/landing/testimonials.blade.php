    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-2xl border border-surface-200 p-6 shadow-card">
                <div class="flex items-center gap-1 mb-4" role="img" aria-label="5 out of 5 stars">
                    @for ($i = 0; $i < 5; $i++)
                        <svg class="w-5 h-5 text-warning-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        <div class="mt-16 text-center">
            <p class="text-sm text-surface-500 mb-6">Trusted by teams at</p>
            <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
                <span class="text-xl font-bold text-surface-500 tracking-tight">Acme Corp</span>
                <span class="text-xl font-bold text-surface-500 tracking-tight">TechStart</span>
                <span class="text-xl font-bold text-surface-500 tracking-tight">CloudBase</span>
                <span class="text-xl font-bold text-surface-500 tracking-tight">PixelForge</span>
                <span class="text-xl font-bold text-surface-500 tracking-tight">BuildRight</span>
            </div>
        </div>
    </div>
</section>
