<footer class="bg-surface-950 text-surface-400">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {{-- Footer Grid --}}
        <div class="py-12 sm:py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            {{-- Brand Column --}}
            <div class="col-span-2 md:col-span-1">
                <a href="/" class="flex items-center gap-2.5 mb-4">
                    <svg class="w-8 h-8 text-brand-400" fill="none" viewBox="0 0 32 32" stroke="currentColor" stroke-width="2" role="img" aria-label="Chronify logo">
                        <circle cx="16" cy="16" r="13" />
                        <path d="M16 8v8l5.5 3.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span class="text-lg font-bold text-white">Chronify</span>
                </a>
                <p class="text-sm leading-relaxed mb-6">
                    Powerful time tracking for teams and freelancers. Built for productivity.
                </p>
                <div class="flex items-center gap-3">
                    {{-- Twitter/X --}}
                    <a href="#" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="Twitter">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                    {{-- GitHub --}}
                    <a href="#" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="GitHub">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- LinkedIn --}}
                    <a href="#" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="LinkedIn">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Mobile Apps</a></li>
                </ul>
            </div>
        ...
        <div class="py-6 border-t border-surface-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-xs text-surface-500">&copy; {{ date('Y') }} Chronify. All rights reserved.</p>
            <p class="text-xs text-surface-500">Made with care for productive teams.</p>
        </div>
    </div>
</footer>
