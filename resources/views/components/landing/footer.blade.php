        ...
        <div class="py-12 sm:py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    {{-- Twitter/X --}}
                    <a href="https://x.com/chronifyio" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="Twitter">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                    {{-- GitHub --}}
                    <a href="https://github.com/chronify" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="GitHub">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- LinkedIn --}}
                    <a href="https://linkedin.com/company/chronify" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-lg bg-surface-800 hover:bg-surface-700 flex items-center justify-center transition-colors" aria-label="LinkedIn">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
